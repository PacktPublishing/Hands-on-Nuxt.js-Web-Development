               ...
               <div class="grid-container">
                ...
                <div class="grid-x grid-padding-x">
                  ...
                  <div class="large-6 medium-12 cell">
                    <label>Name
                      <input type="text" name="name" class="form-input" placeholder="(required)" v-model.trim="name" v-validate="'required|min:3'">
                  ...
                  <div class="large-6 medium-12 cell">
                    <label>Email
                      <input type="email" name="email" class="form-input" placeholder="(required)" v-model.trim="email" v-validate="'required|email'">
                  ...
                  <div class="medium-12 cell">
                    <label>Subject
                      <input type="text" name="subject" class="form-input" placeholder="(required)" v-model.trim="subject" v-validate="'required|min:3'">
                  ...
                  <div class="medium-12 cell">
                    <label>Messager
                      <textarea placeholder="(required)" name="message" class="form-input" rows="10" v-model.trim="message" v-validate="{ required: true, regex: /^(?!.*<[^>]+>).*/ }"></textarea>
