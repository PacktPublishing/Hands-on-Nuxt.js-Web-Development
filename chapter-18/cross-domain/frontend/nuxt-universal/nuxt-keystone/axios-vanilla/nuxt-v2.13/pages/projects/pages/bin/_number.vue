      ...
      <div class="grid-container">
        ...
        <div class="grid-x grid-padding-x">
          ...
          <div class="cell small-4">
            <nuxt-link :to="'/projects/pages/' + posts.prevPage" class="hollow button secondary" v-if="posts.prevPage">
              Previous
            </nuxt-link>
          </div>
          <!-- cell -->
          ...
          <div class="cell small-4 text-right">
            <nuxt-link :to="'/projects/pages/' + posts.nextPage" class="hollow button secondary" v-if="posts.nextPage">
              Next
            </nuxt-link>
          </div>
          <!-- cell -->
...
export default {
  async asyncData ({ params, error, $axios, route }) {
    ...
    let pageNumber = params.number === undefined ? 1 : Math.abs(parseInt(params.number))
    let postsPerPage = 6
    let skip = params.number === undefined ? 0 : (pageNumber - 1) * postsPerPage
    console.log('pages/projects/pages/_number.vue: pageNumber =', pageNumber)
    console.log('pages/projects/pages/_number.vue: skip =', skip)
    ...
    try {
      ...
      console.log('pages/projects/pages/_number.vue: nextPage =', nextPage)
      console.log('pages/projects/pages/_number.vue: prevPage =', prevPage)
