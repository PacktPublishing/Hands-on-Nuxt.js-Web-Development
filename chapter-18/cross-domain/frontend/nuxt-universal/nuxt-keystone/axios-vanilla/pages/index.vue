    ...
    <div class="grid-container full-height">
      <div class="grid-x grid-padding-x small-padding-collapse full-height">
        ...
        <div class="small-10 cell small-offset-1">
          ...
          <!-- row swiper -->
          <div class="row row-swiper autoheight" v-if="post.slideImages" data-aos="fade-in">
            ...
            <div class="swiper-container">
              ...
              <div class="swiper-wrapper">
                ...
                <!-- vue - loop -->
                <template v-for="slide in post.slideImages">

                  <div class="swiper-slide">
                    <nuxt-link :to="'/projects/' + slide.link.name"><img :src="$loadAssetImage(remoteUrl + slide.file.publicUrl)" :alt="slide.alt"></nuxt-link>
                  </div>
