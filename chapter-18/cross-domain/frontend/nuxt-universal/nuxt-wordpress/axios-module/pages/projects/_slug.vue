      ...
      <div class="grid-container fluid">
        <div class="grid-x grid-padding-x small-padding-collapse">
          ...
          <div class="small-12 cell">
            ...
            <div class="image-background image-fullscreen" v-bind:style="{'background-image': 'url(' + post.fullscreen.url + ')' }" data-aos="fade-in">
              <img :src="post.fullscreen.url" :alt="post.fullscreen.alt">
            </div>
            ...
            <div class="large-5 small-12 cell">
              <div class="container-image" data-aos="fade-up">
                <div class="image-centralised">
                  <img :src="item.image.sizes.medium_large" :alt="item.image.alt" class="float-center">
                </div>
...
export default {
  ...
  async asyncData ({ params, error, $axios }) {
    try {
      let { data } = await $axios.get('/api/project/' + params.slug)
      return {
        post: data,
      }
    } catch (err) {
