            ...
            <div class="medium-6 small-12 cell">
              ...
              <div class="container-card" v-on:click="triggerLink($event)" data-aos="fade-up">
                ...
                <div class="card-section">
                  <h2 class="card-heading"><nuxt-link :to="'/projects-nested/' + post.post_name" v-html="post.post_title"></nuxt-link></h2>
                </div>
              </div>
      ...
      <div class="grid-container">
        ...
        <div class="grid-x grid-padding-x">
          ...
          <div class="cell small-4">
            <nuxt-link :to="'/projects-nested/pages/' + posts.prev_page" class="hollow button secondary" v-if="posts.prev_page">
              Previous
            </nuxt-link>
          </div>
          <!-- cell -->
          ...
          <div class="cell small-4 text-right">
            <nuxt-link :to="'/projects-nested/pages/' + posts.next_page" class="hollow button secondary" v-if="posts.next_page">
              Next
            </nuxt-link>
          </div>
          <!-- cell -->
